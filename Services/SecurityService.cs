...
namespace Taraweb
{
    public partial class SecurityService
    {
        ...
        public SecurityService(NavigationManager navigationManager, IHttpClientFactory factory, IWebHostEnvironment env)
        {
            this.baseUri = new Uri($"{navigationManager.BaseUri}odata/Identity/");
            this.httpClient = factory.CreateClient("AuthenTest");
        ...
        public async Task<bool> InitializeAsync(AuthenticationState result)
        {
            ...
            if (env.IsDevelopment() && Principal.Identity.Name == "admin")
            {
